    ...
    return {
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                add(evt) {
                    evt.preventDefault();
                    this._negociacoes.add(new Negociacao_1.Negociacao(new Date(this._inputData.val().replace(/-/g, ",")), parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val())));
                    this._negociacoesView.update(this._negociacoes);
